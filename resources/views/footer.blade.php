<footer class="footer">
    <div class="container footer-inner">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item clearfix">
                    ...
                    <div class="Subscribe-box">
                        ...
                        <p>
                            {!!  Form::email('email', '',['class'=>'form-contact','placeholder'=>'Enter Address']) !!}
                        </p>
                        <p>
                            {!! Form::submit('Subscribe', array('class' => 'btn btn-block btn-color')) !!}
                        </p>
                        {!! Form::close() !!}
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <p class="copy">&copy; 2018 <a href="http://themevessel.com/" target="_blank">Theme Vessel</a>.
