...
<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    <link href="bower_components/demo-bower/assets/admin/vendors_style/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- JQVMap -->
    <link href="bower_components/demo-bower/assets/admin/vendors_style/jqvmap/dist/jqvmap.min.css" rel="stylesheet"/>
    <!-- bootstrap-daterangepicker -->
    <link href="bower_components/demo-bower/assets/admin/vendors_style/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">

    <link href="bower_components/demo-bower/assets/admin/vendors_style/ion.rangeSlider/css/ion.rangeSlider.css" rel="stylesheet">
    <link href="bower_components/demo-bower/assets/admin/vendors_style/ion.rangeSlider/css/ion.rangeSlider.skinFlat.css" rel="stylesheet">
    <!-- Custom Theme Style -->
